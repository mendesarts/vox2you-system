...
const ImportMappingModal = ({ isOpen, onClose }) => {
    const headers = [
    ...
    return (
        <VoxModal
            isOpen={isOpen}
            onClose={onClose}
            title="Mapeamento de Importação de Alunos"
            width="1000px"
        >
            <div style={{ padding: '20px', background: '#f8fafc', borderRadius: '12px' }}>
                <p style={{ color: '#64748b', marginBottom: '20px' }}>
                    Configure os campos para a importação. Use o botão <b>Clonar</b> para criar um novo campo idêntico ao da planilha.
                </p>

                <div style={{ marginBottom: '24px', padding: '16px', background: '#eff6ff', borderRadius: '12px', border: '1px solid #bfdbfe', display: 'flex', gap: '12px', alignItems: 'flex-end' }}>
                    <div style={{ flex: 1 }}>
                    ...
                    <button
                        ...
                        style={{ padding: '10px 20px', background: '#3b82f6', color: '#fff', borderRadius: '8px', border: 'none', fontWeight: 'bold', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }}
                    >
                ...
                <div style={{ display: 'grid', gap: '8px', maxHeight: '500px', overflowY: 'auto', paddingRight: '8px' }}>
                    {headers.map(header => (
                        <div key={header} style={{ display: 'grid', gridTemplateColumns: '1.5fr 40px 1.5fr', gap: '15px', alignItems: 'center', padding: '10px 16px', background: header.startsWith('*') ? '#f0f4f8' : '#fff', border: '1px solid #e2e8f0', borderRadius: '10px' }}>
                ...
                <div style={{ marginTop: '20px', display: 'flex', justifyContent: 'flex-end', gap: '12px' }}>
                    <button
                        onClick={onClose}
                        style={{ padding: '12px 20px', background: 'transparent', color: '#64748b', border: 'none', fontWeight: 'bold', cursor: 'pointer' }}
                    >
                        Cancelar
                    </button>
                    <button
